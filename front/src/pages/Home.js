const Home = () => {
  return (
    <div id="main">
      ...
      {/* <div className="banner"><img src="/banner.jpg"></img></div> */}
      <div className="sections">
        <div className="section left">
          ...
          <div className="paraf">
            <p>
              ...
              the world for free!The best way to learn a language is to actually use it! <span className="l">Language</span><span className="ch"> Chat </span>helps you to connect with native speakers and chat
              with them for free.
            </p>
          </div>
        </div>
        ...
        <div className="paraf">
            <p>
              ...
              country and more.
              Whether it's across the world or across your town, you'll instantly
              find suitable partners to begin a conversation with.
            </p>
          </div>
          <div className="img">
